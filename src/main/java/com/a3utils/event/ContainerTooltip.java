...
public class ContainerTooltip {
    private static final Identifier TEXTURE_SHULKER_BOX = Identifier.withDefaultNamespace("textures/gui/container/shulker_box.png");
    ...
    private static void renderInventoryBackground(GuiGraphics context, int x, int y, int color) {
        ...
        context.blit(RenderPipelines.GUI_TEXTURED, TEXTURE_SHULKER_BOX, x      , y     , 0  , 0  , 7  , 61, shulker_box_texture_width, shulker_box_texture_height, color);
        context.blit(RenderPipelines.GUI_TEXTURED, TEXTURE_SHULKER_BOX, x + 7  , y     , 7  , 0  , 169, 7 , shulker_box_texture_width, shulker_box_texture_height, color);
        context.blit(RenderPipelines.GUI_TEXTURED, TEXTURE_SHULKER_BOX, x      , y + 61, 0  , 159, 169, 7 , shulker_box_texture_width, shulker_box_texture_height, color);
        context.blit(RenderPipelines.GUI_TEXTURED, TEXTURE_SHULKER_BOX, x + 169, y + 7 , 169, 105, 7  , 61, shulker_box_texture_width, shulker_box_texture_height, color);
        context.blit(RenderPipelines.GUI_TEXTURED, TEXTURE_SHULKER_BOX, x+ 7   , y + 7 , 7  , 17 , 162, 54, shulker_box_texture_width, shulker_box_texture_height, color);
    }
